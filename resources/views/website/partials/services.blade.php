...
<section id="services" 
         ...
         class="py-0 md:py-0 pb-16 md:pb-24 relative overflow-hidden {{ $backgroundImage ? '' : 'bg-white' }}">
    @if($backgroundImage)
        <div class="absolute inset-0 z-0 bg-center bg-cover bg-no-repeat" style="background-image: url('{{ $backgroundImage }}');" aria-hidden="true"></div>
