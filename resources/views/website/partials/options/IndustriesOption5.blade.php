...
<section class="py-20 bg-white">
    ...
    <div class="container mx-auto px-6 lg:px-12">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <h2 class="mt-4 text-3xl lg:text-5xl font-black text-[#172455] text-center">{{ $title }}</h2>
            ...
            @foreach($items as $item)
                ...
                <article class="ind5-card group rounded-2xl border bg-white/80 backdrop-blur p-6">
                    <div class="flex items-center justify-between gap-3">
                        <div class="min-w-0">
                            <h3 class="text-lg lg:text-xl font-semibold text-slate-900 truncate">{{ $name }}</h3>
