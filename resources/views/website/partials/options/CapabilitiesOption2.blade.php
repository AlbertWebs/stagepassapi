...
<section id="services" class="relative overflow-hidden py-20 text-white">
    ...
    <div class="relative z-10 container mx-auto px-6 lg:px-12">
        <div class="max-w-3xl mx-auto text-center mb-12">
            ...
            <p class="text-xl text-gray-200 max-w-2xl mx-auto font-medium">{{ $subtitle }}</p>
        ...
        <div id="{{ $sliderId }}" class="mt-4 flex gap-6 overflow-x-auto pb-4 [scrollbar-width:none] [-ms-overflow-style:none]" style="-webkit-overflow-scrolling:touch;">
