    ...
    <div class="container mx-auto px-6 lg:px-12 py-20 relative z-10">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 animate-fade-in-up">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ url('/terms-and-conditions') }}" class="text-gray-300 hover:text-yellow-400 transition-colors font-medium flex items-center">
                            <span class="mr-2">→</span> Terms & Conditions
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/privacy') }}" class="text-gray-300 hover:text-yellow-400 transition-colors font-medium flex items-center">
                            <span class="mr-2">→</span> Privacy Policy
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/sitemap') }}" class="text-gray-300 hover:text-yellow-400 transition-colors font-medium flex items-center">
                ...
                <ul class="space-y-3">
                    @foreach($serviceItems as $item)
                        <li class="text-gray-300 font-medium text-sm flex items-center">
                            <span class="mr-2 text-yellow-400">★</span> {{ $item['label'] ?? '' }}
                        </li>
                    @endforeach
                </ul>
            </div>
