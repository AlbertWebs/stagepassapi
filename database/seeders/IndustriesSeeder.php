    ...
    public function run(): void
    {
        ...
        $records = [
            [
                ...
                'overlay_description' => '<div class=\"text-left\"><p class=\"mb-1.5 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">Services include:</p><ul class=\"list-disc list-inside mb-2 space-y-0.5 text-xs\"><li>Conferences & summits</li><li>Product launches</li><li>AGMs & shareholder meetings</li><li>Award ceremonies</li><li>Team-building events</li></ul><p class=\"mb-1 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">AV Needs:</p><p class=\"text-xs\">Sound systems, LED screens, stage lighting, live streaming, interpretation systems</p></div>',
                'icon_name' => 'Building2',
                'icon_url' => null,
                'image_url' => null,
                'video_url' => null,
            ...
            [
                ...
                'overlay_description' => '<div class=\"text-left\"><p class=\"mb-1.5 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">Services include:</p><ul class=\"list-disc list-inside mb-2 space-y-0.5 text-xs\"><li>Concerts & music festivals</li><li>Comedy shows</li><li>Theatre productions</li><li>Cultural performances</li></ul><p class=\"mb-1 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">AV Needs:</p><p class=\"text-xs\">Line array sound systems, moving lights, LED backdrops, special effects, stage design</p></div>',
                'icon_name' => 'Music',
                'icon_url' => null,
                'image_url' => null,
                'video_url' => null,
            ...
            [
                ...
                'overlay_description' => '<div class=\"text-left\"><p class=\"mb-1.5 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">Services include:</p><ul class=\"list-disc list-inside mb-2 space-y-0.5 text-xs\"><li>Exhibition stands</li><li>Product demo booths</li><li>Brand activations</li><li>Expo pavilions</li></ul><p class=\"mb-1 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">AV Needs:</p><p class=\"text-xs\">Touch screens, video walls, digital signage, interactive displays, booth lighting</p></div>',
            ...
            [
                ...
                'overlay_description' => '<div class=\"text-left\"><p class=\"mb-1.5 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">Services include:</p><ul class=\"list-disc list-inside mb-2 space-y-0.5 text-xs\"><li>University lecture halls</li><li>Training centers</li><li>E-learning environments</li><li>Graduation ceremonies</li></ul><p class=\"mb-1 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">AV Needs:</p><p class=\"text-xs\">Projectors, smart boards, recording systems, lecture capture, hybrid learning setups</p></div>',
                'icon_name' => 'Building2',
                'icon_url' => null,
                'image_url' => null,
                'video_url' => null,
            ...
            [
                ...
                'overlay_description' => '<div class=\"text-left\"><p class=\"mb-1.5 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">Services include:</p><ul class=\"list-disc list-inside mb-2 space-y-0.5 text-xs\"><li>Medical conferences</li><li>Hospital auditoriums</li><li>Surgical training broadcasts</li></ul><p class=\"mb-1 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">AV Needs:</p><p class=\"text-xs\">Presentation systems, live surgery streaming, recording systems, interpretation systems</p></div>',
                'icon_name' => 'Building2',
                'icon_url' => null,
                'image_url' => null,
                'video_url' => null,
            ...
            [
                ...
                'overlay_description' => '<div class=\"text-left\"><p class=\"mb-1.5 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">Services include:</p><ul class=\"list-disc list-inside mb-2 space-y-0.5 text-xs\"><li>National celebrations</li><li>Policy summits</li><li>State functions</li><li>Public forums</li></ul><p class=\"mb-1 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">AV Needs:</p><p class=\"text-xs\">Large-scale sound systems, LED screens, live broadcasting, security-compliant AV solutions</p></div>',
                'icon_name' => 'Building2',
                'icon_url' => null,
                'image_url' => null,
                'video_url' => null,
            ...
            [
                ...
                'overlay_description' => '<div class=\"text-left\"><p class=\"mb-1.5 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">Services include:</p><ul class=\"list-disc list-inside mb-2 space-y-0.5 text-xs\"><li>Store launches</li><li>Mall activations</li><li>Pop-up brand experiences</li></ul><p class=\"mb-1 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">AV Needs:</p><p class=\"text-xs\">Digital signage, LED displays, interactive screens, ambient lighting</p></div>',
                'icon_name' => 'Palette',
                'icon_url' => null,
                'image_url' => null,
                'video_url' => null,
            ...
            [
                ...
                'overlay_description' => '<div class=\"text-left\"><p class=\"mb-1.5 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">Services include:</p><ul class=\"list-disc list-inside mb-2 space-y-0.5 text-xs\"><li>TV studios</li><li>Podcast studios</li><li>Film premieres</li><li>Live broadcasts</li></ul><p class=\"mb-1 text-xs\" style=\"font-weight: 700 !important; color: #172455 !important; text-decoration: underline !important;\">AV Needs:</p><p class=\"text-xs\">Studio lighting, broadcast cameras, control rooms, virtual sets, streaming systems</p></div>',
                'icon_name' => 'Clapperboard',
                'icon_url' => null,
                'image_url' => null,
                'video_url' => null,
