...
<section class="py-20 bg-white">
    <div class="container mx-auto px-6 lg:px-12">
        <h2 class="text-3xl lg:text-5xl font-black text-slate-900 text-center"><?php echo e($title); ?></h2>
            ...
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <article class="group rounded-2xl border border-slate-200 p-6 transition-all duration-300 hover:border-slate-900 hover:shadow-lg">
                    <div class="flex items-center justify-between gap-3">
                        <h3 class="text-lg lg:text-xl font-semibold text-slate-900"><?php echo e($name); ?></h3>
