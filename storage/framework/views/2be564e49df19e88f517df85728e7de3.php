...
<section class="py-8 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
            <?php $__currentLoopData = $logos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div
                    ...
                    <div class="bg-white rounded-2xl p-2 flex items-center justify-center h-full hover:shadow-2xl transition-all duration-500">
                        <div class="w-full h-24 flex items-center justify-center">
                            <div class="w-full h-full flex items-center justify-center p-0">
                                <img 
                                    src="<?php echo e($logo['logo_path'] ?? $logo['src'] ?? ''); ?>" 
                                    alt="<?php echo e($logo['alt_text'] ?? 'Client logo'); ?>" 
...
<?php /**PATH C:\projects\stagepassapi\resources\views/sections/clients.blade.php ENDPATH**/ ?>