        ...
        <div class="grid lg:grid-cols-2 gap-20">
            ...
            <div class="space-y-10 animate-slide-in-left">
                <div>
                    ...
                    <h2 class="text-5xl lg:text-6xl font-black text-[#172455] mt-6 mb-8 leading-tight"><?php echo e($title); ?></h2>
                    <div class="h-2 w-24 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-full mb-8"></div>
                    <p class="text-xl text-gray-700 font-medium"><?php echo e($description); ?></p>
                </div>
                ...
                <div class="space-y-6">
                    <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex items-start space-x-5 group">
                            <div class="w-16 h-16 bg-gradient-to-br <?php echo e($isBlueGradient ? 'from-[#172455] to-[#1e3a8a]' : 'from-yellow-400 to-yellow-600'); ?> rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <?php if($detail['icon'] === 'Phone'): ?>
                                    <svg class="<?php echo e($iconColor); ?> w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                    </svg>
                                <?php elseif($detail['icon'] === 'Mail'): ?>
                                    <svg class="<?php echo e($iconColor); ?> w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                    </svg>
                                <?php elseif($detail['icon'] === 'MapPin'): ?>
                                    <svg class="<?php echo e($iconColor); ?> w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    </svg>
                                <?php elseif($detail['icon'] === 'Clock'): ?>
                                    <svg class="<?php echo e($iconColor); ?> w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                <h3 class="font-black text-[#172455] mb-2 text-lg"><?php echo e($detail['label'] ?? ''); ?></h3>
                                <p class="text-gray-700 font-medium whitespace-pre-line"><?php echo e($detail['value'] ?? ''); ?></p>
                            </div>
                        </div>
...
function handleContactSubmit(e) {
    ...
    fetch('<?php echo e(url("/api/contact/submit")); ?>', {
        method: 'POST',
...
<?php /**PATH C:\projects\stagepassapi\resources\views/sections/contact.blade.php ENDPATH**/ ?>