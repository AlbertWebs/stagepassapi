            ...
            <div class="lg:col-span-8 lg:order-2">
                <div id="industries-option2-grid" class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = array_values($gridItems); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="ind2-reveal" data-ind2-delay="<?php echo e($idx * 0.1); ?>">
                            <article class="ind2-card group relative h-64 rounded-2xl p-[1px] overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-indigo-200/40 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/70"
                                     @click="selectedIndustry = <?php echo \Illuminate\Support\Js::from($industryForJs)->toHtml() ?>; isModalOpen = true"
                                     @keydown.enter.prevent="selectedIndustry = <?php echo \Illuminate\Support\Js::from($industryForJs)->toHtml() ?>; isModalOpen = true"
                                     @keydown.space.prevent="selectedIndustry = <?php echo \Illuminate\Support\Js::from($industryForJs)->toHtml() ?>; isModalOpen = true"
                                     tabindex="0"
                                     role="button"
                            ...
                            <?php if($videoUrl): ?>
                                <iframe
                                    ...
                                    title="<?php echo e($name); ?> video background"></iframe>
                            <?php elseif($img): ?>
                                <img src="<?php echo e($img); ?>" alt="<?php echo e($name); ?>" class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                            <?php else: ?>
                            ...
                            <div class="relative h-full p-8 flex flex-col justify-end">
                                <h3 class="ind2-title text-white text-xl font-semibold transition-transform duration-300 group-hover:-translate-y-1"><?php echo e($name); ?></h3>
                                <p class="ind2-desc mt-2 text-sm text-gray-400 leading-relaxed line-clamp-2">
                                    <?php echo e($desc ?: 'Tailored AV solutions crafted for this industry.'); ?>
            ...
            <aside class="lg:col-span-4 lg:self-end lg:order-1 space-y-4">
                ...
                <div class="rounded-2xl overflow-hidden border border-[#172455]/20 shadow-xl bg-white" style="position: static;">
                    <div class="relative h-[320px] xl:h-[420px]">
                        <?php if($showcaseVideoUrl): ?>
                            <iframe
                                src="<?php echo e($showcaseVideoUrl); ?>"
                                class="ind2-video-cover"
                                frameborder="0"
                                allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"
                                referrerpolicy="strict-origin-when-cross-origin"
                                title="<?php echo e($randomIndustryTitle); ?> video background"></iframe>
                        <?php elseif($showcaseImage): ?>
                            <img src="<?php echo e($showcaseImage); ?>" alt="<?php echo e($title); ?> showcase" class="absolute inset-0 h-full w-full object-cover">
                        <?php else: ?>
                        ...
                        <div class="absolute left-0 right-0 bottom-0 p-5 text-white">
                            ...
                            <p class="mt-2 text-xl font-bold text-white"><?php echo e($randomIndustryTitle); ?></p>
                            <p class="mt-2 text-sm text-slate-100/90"><?php echo e($randomIndustryDescription ?: "Purpose-built AV strategies aligned to each industry's operational goals."); ?></p>
                        </div>
                    </div>
                </div>
            </aside>
...
<?php /**PATH C:\projects\stagepassapi\resources\views/website/partials/options/IndustriesOption2.blade.php ENDPATH**/ ?>