...
<section id="industries" class="py-20 bg-slate-100">
    ...
    <div class="container mx-auto px-6 lg:px-12">
        <div class="text-center max-w-3xl mx-auto">
            ...
            <h2 class="mt-5 text-3xl lg:text-5xl font-black text-[#172455]"><?php echo e($title); ?></h2>
            ...
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <article class="ind2-card group relative h-64 rounded-2xl p-[1px] overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-indigo-200/40">
                    ...
                    <div class="relative h-full p-6 flex flex-col justify-end">
                        <h3 class="text-white text-xl font-bold transition-transform duration-300 group-hover:-translate-y-1"><?php echo e($name); ?></h3>
