...
<div x-data="navbar">
    <nav :class="(isScrolled || <?php echo e($isPageJs); ?>) ? 'bg-[<?php echo e($menuBgHex); ?>] shadow-xl border-b-2 border-[#172455]/10' : 'bg-[<?php echo e($menuBgHex); ?>] backdrop-blur-md'"
        ...
        <div class="container mx-auto px-4 lg:px-12">
            ...
            <div x-show="isMobileMenuOpen" 
                 ...
                 class="lg:hidden py-4 border-t border-[#172455]/10 animate-fade-in bg-gradient-to-b from-[<?php echo e($menuBgHex); ?>] to-[#172455]">
