    ...
    <div class="container mx-auto px-6 lg:px-12">
        <div class="text-center mb-14 animate-fade-in-up">
            ...
            <h2 class="text-4xl lg:text-6xl font-black text-[#172455] mb-4 mt-6">
                <?php if(str_contains($title, 'Industries')): ?>
                    <?php
                        $parts = explode('Industries', $title, 2);
                    ?>
                    <?php echo e($parts[0]); ?><span class="text-yellow-500">Industries</span><?php echo e($parts[1] ?? ''); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <div class="flip-card relative h-72 rounded-2xl overflow-hidden group transition-all duration-500 transform hover:-translate-y-3 hover:shadow-2xl hover:shadow-yellow-500/20 bg-white/80 backdrop-blur border border-yellow-100" style="transition-delay: <?php echo e($index * 100); ?>ms;">
                    ...
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-front absolute inset-0 flex flex-col items-center justify-center p-6 rounded-2xl">
                            <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#172455] to-[#1e3a8a] flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-500">
                                <?php if($iconUrl): ?>
                                    <img src="<?php echo e($iconUrl); ?>" alt="<?php echo e($item['title'] ?? ''); ?>" class="h-10 w-10 object-contain" />
                                <?php else: ?>
                                    <?php if($iconName === 'Music'): ?>
                                    ...
                                    <?php elseif($iconName === 'Clapperboard'): ?>
                            ...
                            <h3 class="text-2xl font-extrabold text-[#172455] mt-6 text-center"><?php echo e($item['title'] ?? ''); ?></h3>
                        ...
                        <div class="flip-card-back absolute inset-0 bg-[#172455] text-white p-6 rounded-2xl flex flex-col items-center justify-center">
                            <?php if($iconUrl): ?>
                                <img src="<?php echo e($iconUrl); ?>" alt="<?php echo e($item['title'] ?? ''); ?>" class="h-12 w-12 object-contain" />
                            <?php else: ?>
                                <?php if($iconName === 'Music'): ?>
                                ...
                                <?php endif; ?>
                            <?php endif; ?>
                            <p class="font-bold text-yellow-400 mt-4 text-lg"><?php echo e($item['title'] ?? ''); ?></p>
...
<?php /**PATH C:\projects\stagepassapi\resources\views/sections/industries.blade.php ENDPATH**/ ?>