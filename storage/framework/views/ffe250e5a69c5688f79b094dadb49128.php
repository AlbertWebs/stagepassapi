...
<?php $__env->startSection('title', 'Contact Us - Get Your AV Quote | StagePass Audio Visual'); ?>
<?php $__env->startSection('description', $pageData['page']['meta_description'] ?? 'Contact StagePass Audio Visual Limited for professional audio visual services, event production, and technical support in Kenya. Get a free quote today.'); ?>
<?php $__env->startSection('keywords', $pageData['page']['meta_keywords'] ?? 'contact StagePass, AV quote Kenya, event production contact, audio visual services Nairobi'); ?>
...
<div class="min-h-screen bg-white">
    ...
    <div class="pt-28 pb-4">
        <div class="mx-auto max-w-4xl px-6">
            <?php echo $__env->make('website.partials.breadcrumb', ['items' => [['label' => 'Contact', 'path' => '/contact']]], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
    ...
    <?php if($pageData && isset($pageData['page'])): ?>
        <main class="mx-auto max-w-4xl px-6 py-16">
            ...
            <?php if(!empty($pageData['page']['content'])): ?>
                <div class="prose prose-lg max-w-none text-gray-700 leading-7 mb-8"><?php echo $pageData['page']['content']; ?></div>
            <?php endif; ?>
            <?php if(!empty($pageData['page']['form_title'])): ?>
                <h2 class="text-2xl font-bold text-[#172455] mb-2"><?php echo e($pageData['page']['form_title']); ?></h2>
            <?php endif; ?>
            <?php if(!empty($pageData['page']['form_description'])): ?>
                <p class="text-gray-600 mb-6"><?php echo e($pageData['page']['form_description']); ?></p>
            <?php endif; ?>
        </main>
    <?php endif; ?>
...
<?php echo $__env->make('website.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\stagepassapi\resources\views/website/pages/contact.blade.php ENDPATH**/ ?>