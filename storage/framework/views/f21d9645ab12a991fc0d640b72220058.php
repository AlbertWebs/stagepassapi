...
<section id="services" 
    ...
    <div class="container mx-auto px-4 lg:px-12 relative z-10">
        ...
        <div class="text-center max-w-4xl mx-auto mb-6 md:mb-10 pt-8 md:pt-12"
            ...
            <h2 class="text-3xl md:text-5xl lg:text-6xl font-black text-[#172455] mt-6 mb-4 leading-tight drop-shadow-sm"><?php echo e($title); ?></h2>
            ...
            <p class="text-lg md:text-xl text-gray-700 font-medium drop-shadow-sm"><?php echo e($description); ?></p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 md:mb-16">
            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="group bg-white border-2 border-gray-200/60 rounded-3xl p-8 shadow-lg shadow-gray-200/30 hover:shadow-2xl hover:shadow-yellow-500/20 hover:border-transparent ring-2 ring-gray-100/50 hover:ring-yellow-200/50 transition-all duration-500 hover:-translate-y-3 cursor-pointer relative overflow-hidden"
                     x-intersect.threshold.0.1="servicesVisible[<?php echo e($index); ?>] = true"
                     :class="servicesVisible[<?php echo e($index); ?>] ? 'animate-fade-in-up' : ''"
                     style="opacity: 1;">
                    ...
                    <div class="relative z-10">
                        <div class="w-20 h-20 bg-gradient-to-br <?php echo e($gradient); ?> rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-125 group-hover:rotate-6 transition-all duration-500 shadow-xl shadow-black/20 group-hover:shadow-2xl group-hover:shadow-black/30 ring-2 ring-white/30">
                            <?php if($iconName === 'Box'): ?>
                            ...
                            <?php elseif($iconName === 'Package'): ?>
                                <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                            <?php else: ?>
                                <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                            <?php endif; ?>
                        </div>
                        <h3 class="text-xl font-black text-[#172455] mb-4 group-hover:text-white transition-colors duration-300"><?php echo e($service->title ?? $service['title'] ?? ''); ?></h3>
                        <p class="text-gray-700 leading-relaxed font-medium group-hover:text-white transition-colors duration-300"><?php echo e($service->description ?? $service['description'] ?? ''); ?></p>
                    </div>
                </div>
