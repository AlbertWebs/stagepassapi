...
<section id="services" class="py-0 md:py-0 pb-16 md:pb-24 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 lg:px-12 relative z-10">
        ...
        <div class="text-center max-w-4xl mx-auto pt-12 md:pt-16 mb-6 md:mb-10 animate-fade-in-up">
            <span class="text-sm font-bold text-yellow-600 tracking-wider uppercase bg-yellow-100 px-4 py-2 rounded-full"><?php echo e($badgeLabel); ?></span>
            <h2 class="text-3xl md:text-5xl lg:text-6xl font-black text-[#172455] mt-6 mb-4 leading-tight"><?php echo e($title); ?></h2>
            <div class="h-2 w-24 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-full mx-auto mb-4"></div>
            <p class="text-xl text-gray-700 max-w-2xl mx-auto font-medium"><?php echo e($description); ?></p>
        </div>

        <!-- Services Grid -->
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 md:mb-16">
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="group bg-white border-2 border-gray-200 rounded-3xl p-8 hover:shadow-2xl hover:border-transparent transition-all duration-500 hover:-translate-y-3 cursor-pointer relative overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-br <?php echo e($gradient); ?> opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
                    
                    <div class="relative z-10">
                        <div class="w-20 h-20 bg-gradient-to-br <?php echo e($gradient); ?> rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-125 group-hover:rotate-6 transition-all duration-500 shadow-xl">
                            <?php
                                $iconName = $service['icon'] ?? 'Box';
                            ?>
                            <?php if($iconName === 'Box' || $iconName === 'Package'): ?>
                        ...
                        <h3 class="text-xl font-black text-[#172455] mb-4 group-hover:text-white transition-colors duration-300"><?php echo e($service['title'] ?? ''); ?></h3>
                        <p class="text-gray-700 leading-relaxed font-medium group-hover:text-white transition-colors duration-300"><?php echo e($service['description'] ?? ''); ?></p>
                    </div>
                </div>
...
<?php /**PATH C:\projects\stagepassapi\resources\views/sections/services.blade.php ENDPATH**/ ?>