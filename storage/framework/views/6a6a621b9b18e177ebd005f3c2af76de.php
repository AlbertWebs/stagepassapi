...
<html lang="en" class="h-full bg-slate-950">
    <head>
        ...
        <title>Admin Login - <?php echo e(config('app.name', 'StagePass')); ?></title>
            ...
            <div class="relative z-10 w-full mx-auto" style="max-width: 28rem;">
                <div class="rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900/90 to-slate-950/90 backdrop-blur-xl shadow-2xl p-8 space-y-8">
                    ...
                    <?php if(count($errors) > 0): ?>
                        <div class="rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-3 space-y-1">
                            <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <p class="text-sm text-red-300 font-medium"><?php echo e($error); ?></p>
                    ...
                    <?php if(session('error')): ?>
                        <div class="rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-3">
                            <p class="text-sm text-red-300 font-medium"><?php echo e(session('error')); ?></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <!-- Login Form -->
                    <form method="POST" action="<?php echo e(route('admin.login')); ?>" class="space-y-6" id="login-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <input
                                    ...
                                    class="flex-1 px-4 py-3 rounded-xl bg-slate-950/50 border <?php echo e($errors->has('username') ? 'border-red-500/50' : 'border-slate-800'); ?> text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500/50 transition-all"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <input
                                    ...
                                    class="flex-1 px-4 py-3 rounded-xl bg-slate-950/50 border <?php echo e($errors->has('password') ? 'border-red-500/50' : 'border-slate-800'); ?> text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500/50 transition-all"
                ...
                <div class="mt-6 text-center">
                    <p class="text-xs text-slate-600">
                        © <?php echo e(date('Y')); ?> StagePass. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\projects\stagepassapi\resources\views/admin/login.blade.php ENDPATH**/ ?>