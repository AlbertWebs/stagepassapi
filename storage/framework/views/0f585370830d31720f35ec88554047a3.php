...
<section x-data="portfolioSection"
         id="portfolio" 
         class="py-16 bg-gradient-to-b from-gray-50 via-gray-100 to-gray-50 relative overflow-hidden">
    <div class="absolute top-20 right-0 w-[600px] h-[600px] bg-[#172455]/10 rounded-full blur-3xl opacity-40 animate-pulse-slow"></div>
    <div class="absolute bottom-20 left-0 w-[600px] h-[600px] bg-yellow-500/10 rounded-full blur-3xl opacity-30 animate-pulse-slower"></div>
