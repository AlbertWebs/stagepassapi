...
<?php $__env->startSection('title', ($pageData['page']['title'] ?? 'Our Services') . ' - Professional AV & Event Production | StagePass'); ?>
<?php $__env->startSection('description', $pageData['page']['meta_description'] ?? 'StagePass offers comprehensive audio visual services including sound systems, stage lighting, LED screens, video conferencing, and full event production in Kenya.'); ?>
<?php $__env->startSection('keywords', $pageData['page']['meta_keywords'] ?? 'AV services Kenya, sound systems, stage lighting, LED screens, event production, video conferencing'); ?>
...
<div class="min-h-screen bg-white">
    ...
    <div class="pt-28 pb-4">
        <div class="mx-auto max-w-4xl px-6">
            <?php echo $__env->make('website.partials.breadcrumb', ['items' => [['label' => 'Services', 'path' => '/services']]], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php echo $__env->make('website.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\stagepassapi\resources\views/website/pages/services.blade.php ENDPATH**/ ?>