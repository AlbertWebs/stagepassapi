        ...
        <div class="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div class="relative">
                <div class="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500">
                    <img src="<?php echo e($imageUrl); ?>" alt="StagePass Audio Visual - Professional event production and AV services in Kenya" 
            ...
            <div class="space-y-8 animate-fade-in-right">
                ...
                <?php if($descriptionSecondary): ?>
                    <div class="text-lg text-gray-700 leading-relaxed"><?php echo $descriptionSecondary; ?></div>
                <?php endif; ?>
                ...
                <div class="grid grid-cols-2 gap-4 pt-4">
                    <?php $__currentLoopData = $highlights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start space-x-3 group">
                            ...
                            <span class="text-gray-700 font-semibold text-sm"><?php echo e($item->text ?? $item['text'] ?? ''); ?></span>
                        </div>
