...
<?php $__env->startSection('title', ($pageData['page']['title'] ?? 'Privacy Policy') . ' - StagePass Audio Visual'); ?>
<?php $__env->startSection('description', $pageData['page']['meta_description'] ?? 'Privacy Policy for StagePass Audio Visual Limited'); ?>
<?php $__env->startSection('keywords', $pageData['page']['meta_keywords'] ?? 'privacy policy, data protection, StagePass privacy'); ?>
...
<div class="min-h-screen bg-white">
    ...
    <div class="pt-28 pb-4">
        <div class="mx-auto max-w-4xl px-6">
            <?php echo $__env->make('website.partials.breadcrumb', ['items' => [['label' => 'Privacy Policy', 'path' => '/privacy']]], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php echo $__env->make('website.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\stagepassapi\resources\views/website/pages/privacy.blade.php ENDPATH**/ ?>