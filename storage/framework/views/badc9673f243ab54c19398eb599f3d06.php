...
style="background: linear-gradient(160deg, #f8fafc 0%, #e0e7ff 22%, #fef3c7 45%, #f1f5f9 70%, #fce7f3 88%, #ecfdf5 100%);">
    ...
    <div class="absolute top-0 left-0 w-[280px] md:w-[380px] h-[220px] md:h-[300px] pointer-events-none z-0" aria-hidden="true">
        <svg class="w-full h-full" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMinYMin slice">
            <defs>
                <linearGradient id="industriesGradientTopLeft" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse">
    ...
    <!-- Decorative curved shapes: gradient matches stats section separator (blue→purple→pink→red→orange→yellow→green) -->
    <div class="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <svg class="absolute w-full h-full min-w-[180%] min-h-[130%] -left-[40%] -top-[8%]" viewBox="0 0 900 700" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
            <defs>
                <linearGradient id="industriesGradient" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stop-color="#3b82f6"/>
                    <stop offset="20%" stop-color="#a855f7"/>
                    <stop offset="35%" stop-color="#ec4899"/>
                    <stop offset="50%" stop-color="#ef4444"/>
    ...
    <div class="container mx-auto px-6 lg:px-12 relative z-10">
        <div class="text-center mb-14"
            ...
            <h2 class="text-4xl lg:text-6xl font-black text-[#172455] mb-4 mt-6">
                ...
                <?php elseif(str_contains($title, 'Industries')): ?>
                    ...
                    <?php if(count($parts) === 2): ?>
                        <span class="text-[#172455]"><?php echo e(trim($parts[0])); ?></span><span class="text-yellow-500">Industries</span><span class="text-[#172455]"><?php echo e($parts[1]); ?></span>
                    <?php else: ?>
                        <?php echo e($title); ?>
            ...
            <!-- <p class="text-lg md:text-xl text-[#172455] max-w-3xl mx-auto"><?php echo e($subtitle); ?></p> -->
            <p class="text-xl text-gray-700 max-w-2xl mx-auto font-medium drop-shadow-sm"><?php echo e($subtitle); ?></p>
        </div>

        <div class="wow grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10" data-wow="fade-up" data-wow-delay="150">
            <?php $__currentLoopData = $industryDataDisplay; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
