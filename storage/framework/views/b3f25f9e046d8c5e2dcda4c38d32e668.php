        ...
        <div class="grid lg:grid-cols-2 gap-12 md:gap-20 items-center animate-fade-in-up">
            ...
            <div class="relative">
                <div class="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500">
                    <img src="<?php echo e($imageUrl); ?>" alt="Event Production" class="w-full h-[300px] md:h-[550px] object-cover" />
                ...
                <div class="absolute -bottom-4 -right-4 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl shadow-2xl p-4 max-w-xs animate-float">
                    <div class="text-center">
                        <div class="text-3xl md:text-5xl font-black text-white"><?php echo e($statValue); ?></div>
                        <div class="text-white font-bold mt-2"><?php echo e($statLabel); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-8 animate-fade-in-right">
                <div>
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black text-[#172455] mt-6 leading-tight"><?php echo e($title); ?></h2>
                    <div class="h-2 w-24 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-full mt-4"></div>
                </div>

                <p class="text-xl text-gray-700 leading-relaxed font-medium"><?php echo e($descriptionPrimary); ?></p>
                <p class="text-xl text-gray-700 leading-relaxed font-medium"><?php echo e($descriptionSecondary); ?></p>
                ...
                <div class="grid grid-cols-2 gap-4 pt-4">
                    <?php $__currentLoopData = $highlights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $highlight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start space-x-3 group">
                            ...
                            <span class="text-gray-700 font-semibold text-sm"><?php echo e($highlight['text'] ?? ''); ?></span>
                        </div>
        ...
        <div class="mt-16 md:mt-32 grid md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div class="text-center animate-fade-in-up">
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-yellow-500/10 to-transparent"></div>
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-yellow-400 mb-3 md:mb-4"><?php echo e($visionTitle); ?></h3>
                    <p class="text-lg md:text-2xl lg:text-3xl font-black text-white leading-tight"><?php echo e($visionText); ?></p>
                </div>
            </div>

            <!-- Our People Section -->
            <?php if($peopleTitle && $peopleDescription): ?>
            <div class="text-center animate-fade-in-up">
...
<?php /**PATH C:\projects\stagepassapi\resources\views/sections/about.blade.php ENDPATH**/ ?>