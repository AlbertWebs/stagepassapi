...
<section class="relative py-24 overflow-hidden text-white">
    ...
    <?php if($youtubeId): ?>
        <iframe
            class="cap3-bg-video"
            src="https://www.youtube.com/embed/<?php echo e($youtubeId); ?>?autoplay=1&mute=1&loop=1&playlist=<?php echo e($youtubeId); ?>&controls=0&showinfo=0&modestbranding=1&rel=0&playsinline=1"
    ...
    <div class="relative container mx-auto px-6 lg:px-12">
        <div class="max-w-4xl">
            ...
            <h2 class="mt-5 text-3xl sm:text-4xl lg:text-6xl font-black leading-tight"><?php echo e($title); ?></h2>
            <p class="mt-5 max-w-3xl text-slate-200/95 text-base sm:text-lg"><?php echo e($subtitle); ?></p>
        </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <article class="cap3-card h-full flex flex-col p-7 lg:p-8">
                    <p class="absolute right-5 top-5 text-[11px] font-bold tracking-[0.18em] text-white/35">
                        <?php echo e(str_pad((string) ($idx + 1), 2, '0', STR_PAD_LEFT)); ?>

                    </p>
                    <div class="flex items-center gap-3">
                        <span class="cap3-chip-dot inline-block h-2.5 w-2.5 rounded-full bg-amber-300"></span>
                    </div>
                    <h3 class="mt-4 text-xl sm:text-2xl font-bold leading-snug text-white"><?php echo e($titleItem); ?></h3>
                    <p class="mt-4 text-white/85 text-sm lg:text-base leading-relaxed">
                        <?php echo e($desc ?: 'Tailored production support designed to elevate event experiences from planning to live delivery.'); ?>
