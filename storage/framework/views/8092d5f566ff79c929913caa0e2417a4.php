<?php
    ...
    $serviceItems = $footer['service_items'] ?? [];
    $isHomepage = request()->is('/');
?>

<footer class="bg-gradient-to-br from-[#172455] via-[#1e3a8a] to-[#172455] text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 lg:px-12 py-20 relative z-10">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 animate-fade-in-up">
            <!-- Column 1 - Brand -->
            <div class="space-y-6">
                <img 
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="<?php echo e(url('/terms-and-conditions')); ?>" class="text-gray-300 hover:text-yellow-400 transition-colors font-medium flex items-center">
                            <span class="mr-2">→</span> Terms & Conditions
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/privacy')); ?>" class="text-gray-300 hover:text-yellow-400 transition-colors font-medium flex items-center">
                            <span class="mr-2">→</span> Privacy Policy
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/sitemap')); ?>" class="text-gray-300 hover:text-yellow-400 transition-colors font-medium flex items-center">
                            <span class="mr-2">→</span> Sitemap
                        </a>
                    </li>
                    <li>
                        <button onclick="openQuoteModal()" class="text-gray-300 hover:text-yellow-400 transition-colors font-medium flex items-center w-full text-left">
                            <span class="mr-2">→</span> Get AV Quote
                        </button>
                    </li>
                </ul>
            </div>
                ...
                <ul class="space-y-3">
                    <?php $__currentLoopData = $serviceItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="text-gray-300 font-medium text-sm flex items-center">
                            <span class="mr-2 text-yellow-400">★</span> <?php echo e($item['label'] ?? ''); ?>
        ...
        <!-- Copyright -->
        <div class="pt-8 border-t border-white/10 text-center animate-fade-in-up" style="transition-delay: 300ms;">
...
<?php /**PATH C:\projects\stagepassapi\resources\views/partials/footer.blade.php ENDPATH**/ ?>