<div x-data="{
    ...
    async handleSubmit() {
        ...
        try {
            const response = await fetch('<?php echo e(url('/api/quote/submit')); ?>', {
                method: 'POST',
...
<?php /**PATH C:\projects\stagepassapi\resources\views/website/partials/quote-modal.blade.php ENDPATH**/ ?>